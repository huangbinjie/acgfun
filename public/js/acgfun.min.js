...
var ws=new WebSocket("ws://localhost"),message={},user={},members=[],guests=0,socketed=!1;ws.onopen=function(){socketed=!0,ws.onmessage=function(data){if(message=JSON.parse(data.data),console.log(data.data),"/plaza"===message.path)if(members=message.members,guests=message.guest,"/join/member"===message.suffix){if(0===members.length)return;void 0===members.face&&(members.face="default.jpg"),$("#plaza-groups").append('<li class="inline-block" id="'+members._id+'"><a href="/user/'+members._id+'"><img src="uploads/faces/'+members.face+'"></a><p class="text-center">'+members.nick+"</p></li>")}else if("/left/member"===message.suffix)$("#"+members._id).remove();else if("/chat"===message.suffix)$(".chat-dialog").prepend('<li class="chat"><a href="/user/'+members._id+'"><img src="uploads/faces/'+members.face+'"></a><span class="username">'+members.nick+":</span><span>"+message.message+"</span></li>");else{if(0===members.length)return;$("#plaza-groups").empty();for(var i in members)void 0===members[i].face&&(members[i].face="default.jpg"),$("#plaza-groups").append('<li class="inline-block" id="'+members[i]._id+'"><a href="/user/'+members[i]._id+'"><img src="uploads/faces/'+members[i].face+'"></a><p class="text-center">'+members[i].nick+"</p></li>")}}};